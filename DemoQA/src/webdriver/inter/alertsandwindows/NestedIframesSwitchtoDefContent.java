...
public class NestedIframesSwitchtoDefContent {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        //Locate the Element inside the Frame1
        WebElement frame1Element1= driver.findElement(By.tagName("body"));
        ...
        WebElement mainPageText=driver.findElement(By.xpath("//div[@id='framesWrapper']/div[1]"));
        String frameText=mainPageText.getText();
