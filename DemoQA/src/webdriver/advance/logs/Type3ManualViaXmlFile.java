...
public class Type3ManualViaXmlFile {

	private static WebDriver driver;

	private static Logger Log = Logger.getLogger(Type3ManualViaXmlFile.class.getName());

	public static void main(String[] args) {

		DOMConfigurator.configure("xmls/log4j-Main.xml");
