...
public class StandAloneTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("userEmail")).sendKeys("chuy@bah.com");
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("#toast-container"))); // wait until this toast container is not displayed
		//ng-animating
